...
`;
  ...
  if (createProductElement)
    createProductElement.addEventListener('click', createProduct);  tableBodyElement.appendChild(productElement);
...
window.addEventListener('load', () => {
 ...
 calculatePricesBtn.addEventListener('click', calculateAll, false);
}
  //... your code goes here
